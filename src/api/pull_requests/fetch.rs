...
pub async fn fetch_and_cache_pr(
    ...
    // Fetch PR metadata
    let gh_pr = crate::github::fetch_pull_request(github, owner, repo, number).await?;
    ...
    let issue_comments = crate::github::fetch_issue_comments(github, owner, repo, number).await?;
    ...
    let review_comments = crate::github::fetch_review_comments(github, owner, repo, number).await?;
    ...
    // Fetch commits
    let gh_commits = crate::github::fetch_commits(github, owner, repo, number).await?;
    for c in &gh_commits {
    ...
    let check_run_list = crate::github::fetch_check_runs(github, owner, repo, &head_sha).await?;
